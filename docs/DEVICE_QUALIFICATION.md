...
| M2 Max / `apple,j416c`, `apple,t6021` | Inventory, bounded smokes, then installed `libva-v4l2_request-avd 1.3.r11-2` (`db3014f`) plus `updates/` patched module loaded by `modprobe`; [inventory](evidence/issue18/m2-j416c-inventory.json), [installed stack](evidence/issue18/t6021-installed-stack/README.md) | Experimental. Installed-stack Fluster totals match r11 pass sets: HEVC 144/147, AVC 73/135, FRExt 27/69, VP9 216/305. Generated matrices, export/lifecycle and mpv OpenGL VA-API client pass. AVC `FM1_FT_E` is `software_fallback` not `decode_error`. Boot-at-login not yet evidenced. Earlier three-vector smokes stay [review-limited](evidence/issue18/t6021-review.md). Do not copy these rows onto other chips. |
